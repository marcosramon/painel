...
// 2. CONFIGURAÇÃO DO FIREBASE (Cole as suas credenciais aqui de novo!)
    ...
    <div style={{minHeight:"100vh", background:T.gray100, fontFamily:T.font}}>
      ...
      <header style={{
        ...
        <div style={{position:"relative", maxWidth:640, margin:"0 auto"}}>
          <p style={{fontSize:11, letterSpacing:"0.18em", textTransform:"uppercase", color:T.blue300, margin:"0 0 10px", fontWeight:500}}>
            IFB · Campus Brasília
          </p>
