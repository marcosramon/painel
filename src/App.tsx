...
export default function App() {
  ...
  const ADMIN_PASSWORD = "ifb2026admin";

  // ⚠️ CONTROLE DE EXCLUSÃO — mude para true, faça commit e push para
  // liberar a lixeira no painel admin. Volte para false após o uso.
                    ...
                    <table style={{width:"100%", borderCollapse:"collapse", fontSize:12, fontFamily:T.font}}>
                      <thead>
                        <tr style={{borderBottom:`2px solid ${T.gray200}`}}>
                          {[...["Nome","Cidade","UF","Formação","Profissão","Expectativas"], ...(ENABLE_DELETE ? [""] : [])].map((h, i) => (
                            <th key={i} style={{
